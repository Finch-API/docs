...
We suggest combining the Deductions product with [Organization](/docs/Products/Organization/Overview.md) and [Payroll](/docs/Products/Pay/Overview.md) for end-to-end control over the deductions process. The Organization and Payroll products offer visibility into changes in employment and pay data, while the Deductions product helps you control those pay changes.
...
We suggest selecting an automated integration for your first connection, which does not require a [configuration period](docs/Integrations/Integration-Types.md#configuration-periods). Navigate to our [Providers](docs/Integrations/Providers.md) page to find an employment system that supports our Deductions product. Then, follow the steps below:
...
Learn more about [implementing Deductions](docs/Implementation-Guide/Communicate/Write-Data.md).
