...
### Payment
The [`/payment`](https://developer.tryfinch.com/docs/reference/b811fdc2542ca-payment) API endpoint provides the ability to view company payroll payments. This endpoint shows aggregate information about a company's payruns and links to the individual employee pay statements generated from a payrun.

### Pay Statement
The [`/pay-statement`](https://developer.tryfinch.com/docs/reference/d5fd02c41e83a-pay-statement) API endpoint provides detailed information about individual pay stubs for each employee. You can use tax and deduction line items to verify that deductions and contributions have been applied, view gross and net pay to determine year-to-date earnings, and view all the details of exactly what goes into an employee's paycheck.
