...
![deel-setup-diagram.png](../../../assets/images/deel/deel-setup-diagram.png)
...
1. Select the **I’m A Business** option and click **Next**
    ...
    ![deel_signup_1_whitespace.png](../../../assets/images/deel/deel_signup_1_whitespace.png)

1. Either **Sign Up Using Google SSO** or fill in the form below and select **Create Your Deel Account**


    ![deel_signup_2_whitespace.png](../../../assets/images/deel/deel_signup_2_whitespace.png)
...
1. If your form was submitted successfully, you’ll be taken to a confirmation page. You should now have received an email confirmation in your inbox. Open this email and follow the ensuing instructions to log into your generated account.
    ...
    ![deel_signup_3_whitespace.png](../../../assets/images/deel/deel_signup_3_whitespace.png)
...
1. After logging into your account, follow the ensuing instructions to complete your account setup. When prompted with the solutions selection page, you may select **Skip**, and proceed with the remaining steps to complete your setup.
    ...
    ![deel_signup_4_whitespace.png](../../../assets/images/deel/deel_signup_4_whitespace.png)
...
1. Voila! Your account setup is now complete! You should now be looking at your Deel home page, which should look something like the screenshot below.
    ...
    ![deel_homepage_whitespace.png](../../../assets/images/deel/deel_homepage_whitespace.png)
...
1. Follow Deel’s [**Create an App**](https://developer.deel.com/docs/oauth2-apps#create-an-app) guide to create your app. Be sure to set your app type to **Organization** and to set your app's Redirect URL to `https://connect.tryfinch.com/auth/deel`!
    ...
    ![deel_createapp_form_whitespace.png](../../../assets/images/deel/deel_createapp_form_whitespace.png)
    
    > **IMPORTANT:** Copy and store your app secret (client secret) as it won't show again!


    ![deel_credentials_view_whitespace.png](../../../assets/images/deel/deel_credentials_view_whitespace.png)
