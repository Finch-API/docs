...
You can also use the `connection_status` on the [`/introspect`](https://developer.tryfinch.com/reference/introspect) endpoint to see the connection status of the assisted account.
```json
{
  ...
