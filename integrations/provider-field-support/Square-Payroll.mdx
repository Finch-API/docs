...
<summary><h4 style="display:inline">Payment</strong></summary>
  ...
  `pay_date` | <strong><span style="color:grey">-</span></strong>
  `debit_date` | <strong><span style="color:grey">-</span></strong>
  `company_debit` | <strong><span style="color:grey">-</span></strong>
  `gross_pay` | <strong><span style="color:grey">-</span></strong>
  `net_pay` | <strong><span style="color:grey">-</span></strong>
  `employer_taxes` | <strong><span style="color:grey">-</span></strong>
  `employee_taxes` | <strong><span style="color:grey">-</span></strong>
  `individual_ids` | <strong><span style="color:grey">-</span></strong>
...
<summary><h4 style="display:inline">Pay Statement</strong></summary>
  ...
  Field | Support
  --- | ---
  `individual_id` | <strong><span style="color:grey">-</span></strong>
  `type` | <strong><span style="color:grey">-</span></strong>
  `payment_method` | <strong><span style="color:grey">-</span></strong>
  `total_hours` | <strong><span style="color:grey">-</span></strong>
  `gross_pay` | <strong><span style="color:grey">-</span></strong>
  `net_pay` | <strong><span style="color:grey">-</span></strong>
  `earnings[].type` | <strong><span style="color:grey">-</span></strong>
  `earnings[].name` | <strong><span style="color:grey">-</span></strong>
  `earnings[].amount` | <strong><span style="color:grey">-</span></strong>
  `earnings[].currency` | <strong><span style="color:grey">-</span></strong>
  `earnings[].hours` | <strong><span style="color:grey">-</span></strong>
  `taxes[].type` | <strong><span style="color:grey">-</span></strong>
  `taxes[].name` | <strong><span style="color:grey">-</span></strong>
  `taxes[].amount` | <strong><span style="color:grey">-</span></strong>
  `taxes[].currency` | <strong><span style="color:grey">-</span></strong>
  `employee_deductions[].type` | <strong><span style="color:grey">-</span></strong>
  `employee_deductions[].name` | <strong><span style="color:grey">-</span></strong>
  `employee_deductions[].amount` | <strong><span style="color:grey">-</span></strong>
  `employee_deductions[].currency` | <strong><span style="color:grey">-</span></strong>
  `employee_deductions[].pre_tax` | <strong><span style="color:grey">-</span></strong>
...
**FSA Dependent** | `company_contribution`: `fixed`, `percent`<br>`employee_deduction`: `fixed`, `percent`<br>`catch_up`<br>`annual_maximum`
**FSA Medical** | `company_contribution`: `fixed`, `percent`<br>`employee_deduction`: `fixed`, `percent`<br>`catch_up`<br>`annual_maximum`
**Section 125 Dental** | `company_contribution`: `fixed`, `percent`<br>`employee_deduction`: `fixed`, `percent`<br>`catch_up`<br>`annual_maximum`
**Section 125 Medical**| `company_contribution`: `fixed`, `percent`<br>`employee_deduction`: `fixed`, `percent`<br>`catch_up`<br>`annual_maximum`
**Section 125 Vision** | `company_contribution`: `fixed`, `percent`<br>`employee_deduction`: `fixed`, `percent`<br>`catch_up`<br>`annual_maximum`
**Commuter** | `company_contribution`: `fixed`, `percent`<br>`employee_deduction`: `fixed`, `percent`<br>`catch_up`<br>`annual_maximum`
**Custom post-tax** | `employee_deduction`: `fixed`, `percent`<br>`catch_up`<br>`annual_maximum`
