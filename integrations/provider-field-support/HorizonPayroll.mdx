...
title: Credentials
-->
Field support for employers authenticating via Credentials
...
<summary><h4 style="display:inline">Directory</strong></summary>
  ...
  `manager.name` | <strong><span style="color:grey">-</span></strong>
...
<summary><h4 style="display:inline">Pay Statement</strong></summary>
  ...
  `taxes[].employer` | <strong><span style="color:green">✓</span></strong>
