...
`rate_limit_exceeded_error` | `finch_application_rl` | 429 | The application has exceeded Finch's [application rate limits](/docs/Development-Guides/Rate-Limits#application-rate-limits).
`rate_limit_exceeded_error` | `finch_api_ip_rl` | 429 | The application has exceeded Finch's [IP Address rate limits](/docs/Development-Guides/Rate-Limits#ip-address-rate-limits).
`rate_limit_exceeded_error` | `finch_auth_ip_rl` | 429 | The application has exceeded [Finch Connect rate limits](/docs/Development-Guides/Rate-Limits#finch-connect-rate-limits).
`rate_limit_exceeded_error` | `upstream_rate_limit_exceeded` | 429 | The application has exceeded [upstream provider rate limits](/docs/Development-Guides/Rate-Limits#upstream-provider-rate-limits).
