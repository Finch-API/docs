...
* Requests for connections using [Assisted Connect](/integrations/providers#integration-types), including [Assisted Deductions](/implementation-guide/Communicate/Write-Data#assisted-deductions)
* Requests for [pay statements](/developer-resources/Data-Syncs#pay-statements) which exist but have not yet been fetched
* Requests for connections utilizing [authentication fallback](/implementation-guide/Optimize/Increase-Employer-Adoption#set-up-authentication-fallback)
