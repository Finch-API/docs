...
-->
<!--
title: "Express.js server example using Node SDK"
lineNumbers: true
-->
```javascript
...
-->
<!--
title: "FastAPI server example using Python SDK"
lineNumbers: true
-->
```python
...
-->
<!--
title: "SpringBoot server example using Java SDK"
lineNumbers: true
-->
```java
...
-->
<!--
title: "SpringBoot sever example using Kotlin SDK"
lineNumbers: true
-->
```kotlin
import com.tryfinch.api.client.FinchClient
...
-->
<!--
title: net/http server example using Go SDK
lineNumbers: true
-->
```go
import (
