---
stoplight-id: x0h6mfmxddhll
---

# Enable Social Security Number (SSN) Field

<!-- theme: danger -->
> SSN is a secure field in the Finch API. Your use case needs to be approved by your Developer Success Representative before enabling. However, you can test SSN via the [Finch Sandbox](/docs/Implementation-Guide/Test/Finch-Sandbox.md) without any approval.
