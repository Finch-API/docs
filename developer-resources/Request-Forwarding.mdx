...
> Request Forwarding is only supported for connections that were established via the [API-based authentication method](/Get-Started/Employment-API-Glossary#authentication-method).
