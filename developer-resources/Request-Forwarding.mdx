...
You can [watch a video demonstration](https://www.loom.com/share/15ca7fb93c2d43b9a052362fd3368e37) that exhibits how to use the [/forward](https://developer.tryfinch.com/docs/reference/dwnn4o21afzyr-request-forwarding) API for accessing deeper data sets within an employment system.
...
<!-- focus: false -->
![finch_standard_api.png](../../assets/images/request-forwarding/finch_standard_api.png)
...
<!-- focus: false -->
![finch_request_forwarding.png](../../assets/images/request-forwarding/finch_request_forwarding.png)
...
> Request Forwarding is only supported for connections that were established via the [API-based authentication method](/docs/Get-Started/Employment-API-Glossary.md#authentication-method).
