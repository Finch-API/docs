...
More information about how Finch Connect works and how to implement it into your application can be found in the  [Set Up Finch Connect](/docs/Implementation-Guide/Connect/Set-Up-Finch-Connect) of the Finch Implementation Guide.