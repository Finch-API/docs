...
See our [Implementation Guide](/implementation-guide/Introduction) for more detailed instructions on how to [set up Finch Connect](/implementation-guide/Connect/Set-Up-Finch-Connect).



<Steps>
    <Step title="Open Finch Connect">
        ![Open Finch Connect](/images/finch-connect/open-finch-connect.jpg)


        Employers access Finch Connect from within your application. We suggest launching Finch Connect during the employer onboarding process. There are many ways to [Increase Employer Adoption](/implementation-guide/Optimize/Increase-Employer-Adoption) of Finch Connect. 
    </Step>

    <Step title="Connect a provider">

        ![Finch Connect Screens](/images/finch-connect/finch-connect-screens.jpg)
    ...
    <Step title="Receive Data">
        ...
        ![Finch Connect Screens](/images/finch-connect/successful-connection-screen.jpg)
