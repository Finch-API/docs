...
<!--
title: "Example /introspect response"
-->
```json
{
...
<!-- focus: false -->
![1-To-1 Database Schema](../../../assets/images/manage-connections/single-connection-database.jpg)
...
<!-- focus: false -->
![1-To-Many Database Schema](../../../assets/images/manage-connections/multiple-connection-database.jpg)
...
To have your customer create multiple connections in your application, your "onboarding" flow or "connections" page must allow them to go through [Finch Connect](/docs/Implementation-Guide/Connect/Set-Up-Finch-Connect.md) multiple times.
...
<!-- focus: false -->
![](../../../assets/images/manage-connections/multiple-connections-UI.png)

## Edge cases

### Reauthentication

In [reauthentication](docs/Developer-Resources/Reauthentication.md) situations, your customer should be prompted to reconnect their provider again before continuing to use the application. When the Finch Connect flow is completed, a new access token will be generated. Simply replace the old token with the new token and start making Finch API requests with the updated token like before.

### Repeating employees

In the [multi-provider or multi-company](#define-connections) scenarios, if your application is combining data across multiple access tokens, you may need to [reconcile employees](docs/Developer-Resources/Reconcile-employees.md) between responses in order to merge employee data properly.

---

## Checkpoint + Next Step
<!-- theme: success -->
> After completing this step, you should know how to associate access tokens with multiple accounts for each new connection. With proper connection organization, you are ready to use the access token to [make API requests](/docs/Implementation-Guide/Communicate/Read-Data.md) to Finch's various endpoints.


## Learn more

- [Control User Access](/docs/Implementation-Guide/Secure/Control-Access.md)
- [Set Up Finch Connect](/docs/Implementation-Guide/Connect/Set-Up-Finch-Connect.md)
- [Reauthenticating Connections](/docs/Developer-Resources/Reauthentication.md)
- [Reconcile Employees](/docs/Developer-Resources/Reconcile-employees.md)
- [Integration Types: Automated](/docs/Integrations/Integration-Types.md#automated)
