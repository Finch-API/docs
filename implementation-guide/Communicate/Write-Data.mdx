...
If you are already familiar with [Reading Data](/docs/Implementation-Guide/Communicate/Read-Data) from the Finch `Orgainzation` and `Payroll` products, our `Deductions` product allows developers to write [contributions](/docs/Get-Started/Employment-API-Glossary#contribution) and [deductions](/docs/Get-Started/Employment-API-Glossary#deduction) across payroll providers for retirement, medical, and fringe benefits.
...
This information is available in [our provider documentation](/docs/Integrations/Providers).
...
![automated-benefits.png](/docs/images/automated-benefits-sequence-diagram.png)
...
- [Read more about Assisted Deductions](docs/Integrations/Integration-Types)
...
![assisted-benefits.png](/docs/images/assisted-benefts-sequence-diagram.png)
