...
- [ ] Get in touch with your Finch Representative if you would like [specific auth methods](/Get-Started/Employment-API-Glossary#authentication-method) displayed in [Finch Connect](/Implementation-Guide/Connect/Set-Up-Finch-Connect), and we can manage it for you.
...
- [ ] Integrate an [external rate limiter](/Implementation-Guide/Optimize/Mitigate-Errors#rate-limit-errors) into your application that respects the Finch API [rate limits](https://developer.tryfinch.com/docs/reference/64f780582a5a2-rate-limits).
...
Your application should [expect](https://developer.tryfinch.com/docs/reference/1f80003f67f0d-error-types) and [handle errors](/Implementation-Guide/Optimize/Mitigate-Errors) from the Finch API.
...
- [ ]  Some employment systems like Bamboo HR, Zenefits, and Gusto allow you to sign up for free demos. You can use these accounts to [test against a real employment system](/Implementation-Guide/Test/Live-Providers).
