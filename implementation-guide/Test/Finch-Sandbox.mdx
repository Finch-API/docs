...
To use the sandbox environment, simply open [Finch Connect](/docs/Implementation-Guide/Connect/Set-Up-Finch-Connect) with the `sandbox` query parameter set to `true`.
